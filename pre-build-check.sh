...
#    source <(curl -sSL "https://raw.githubusercontent.com/bhartshorn/commons/master/scripts/check_prebuild.sh")
# ------------------
# source: https://raw.githubusercontent.com/bhartshorn/commons/master/scripts/check_prebuild.sh
