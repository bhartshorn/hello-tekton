...
#    source <(curl -sSL "https://raw.githubusercontent.com/bhartshorn/commons/master/scripts/check_vulnerabilities.sh")
# ------------------
# source: https://raw.githubusercontent.com/bhartshorn/commons/master/scripts/check_vulnerabilities.sh
