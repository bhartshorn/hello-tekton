...
#    source <(curl -sSL "https://raw.githubusercontent.com/bhartshorn/commons/master/scripts/build_image.sh")
# ------------------
# source: https://raw.githubusercontent.com/bhartshorn/commons/master/scripts/build_image.sh
